...
<div class="container mt-4">
    ...
    <h2 class="mb-4">Liste des contacts</h2>
        {{-- button ajouter et bar de recherche --}}
    <div class="row mb-4">
      ...
      <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <div class="badge bg-primary text-light "> {{$contact->statut}}</div>
                @elseif ($contact->statut == 'client')
                <div class="badge bg-info  text-light"> {{$contact->statut}}</div>
                @elseif ($contact->statut == 'prospect')
                <div class="badge bg-success text-light"> {{$contact->statut}}</div>
                @endif
            </td>
            <td >
